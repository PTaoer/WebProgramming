...
Page({
  data: {
    imgUrls: [
      'http://47.100.44.255/images/product/detail-wucanrou/01.JPG',
      'http://47.100.44.255/images/product/detail-wucanrou/02.JPG',
      'http://47.100.44.255/images/product/detail-wucanrou/03.JPG'
    ],
  ...
  toCar() {
    ...
    var cargo = {
      code: '0015',
      num: num,
      name: '上海梅林午餐肉罐头340g*5',
      url: 'http://47.100.44.255/images/product/detail-wucanrou/01.JPG',
      price: '68.90',
      select: 'circle'
    };
    var app = getApp();
