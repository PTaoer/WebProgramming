...
Page({
  data: {
    imgUrls: [
      'http://47.100.44.255/images/product/detail-niunai/01.JPG',
      'http://47.100.44.255/images/product/detail-niunai/02.JPG',
      'http://47.100.44.255/images/product/detail-niunai/03.JPG'
    ],
  ...
  toCar() {
    ...
    var cargo = {
      ...
      num: num,
      name: '光明纯牛奶',
      url: 'http://47.100.44.255/images/product/detail-niunai/01.JPG',
      price: '49.90',
      select: 'circle'
    };
    var app = getApp();
