...
Page({
  data: {
    imgUrls: [
      'http://47.100.44.255/images/product/detail-binggun/01.jpg',
      'http://47.100.44.255/images/product/detail-binggun/02.jpg'
    ],
  ...
  toCar() {
    ...
    var cargo = {
      ...
      num: num,
      name: '马迭尔冰棍冰淇淋',
      url: 'http://47.100.44.255/images/product/detail-binggun/01.jpg',
      price: '50.00',
      select: 'circle'
    };
    var app = getApp();
