...
Page({
  data: {
    imgUrls: [
      'http://47.100.44.255/images/product/detail-fenglisu/01.JPG',
      'http://47.100.44.255/images/product/detail-fenglisu/02.JPG',
      'http://47.100.44.255/images/product/detail-fenglisu/03.JPG'
    ],
  ...
  toCar() {
    ...
    var cargo = {
      code: '0007',
      num: num,
      name: '微热山丘凤梨酥50g*6颗装2',
      url: 'http://47.100.44.255/images/product/detail-fenglisu/01.JPG',
      price: '34.90',
      select: 'circle'
    };
    var app = getApp();
