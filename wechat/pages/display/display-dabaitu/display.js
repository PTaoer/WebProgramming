...
Page({
  data: {
    imgUrls: [
      'http://47.100.44.255/images/product/detail-dabaitu/01.jpg',
      'http://47.100.44.255/images/product/detail-dabaitu/02.jpg'
    ],
  ...
  toCar() {
    ...
    var cargo = {
      code: '0004',
      num: num,
      name: '大白兔奶糖500g牛奶糖原味散装',
      url: 'http://47.100.44.255/images/product/detail-dabaitu/01.jpg',
      price: '21.80',
      select: 'circle'
    };
    var app = getApp();
