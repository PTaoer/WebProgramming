...
Page({
  data: {
    imgUrls: [
      'http://47.100.44.255/images/product/detail-ruantang/01.png',
      'http://47.100.44.255/images/product/detail-ruantang/02.png'
    ],
  ...
  toCar() {
    ...
    var cargo = {
      ...
      num: num,
      name: '水果果汁软糖罐装维生素橡皮糖',
      url: 'http://47.100.44.255/images/product/detail-ruantang/01.png',
      price: '38.60',
      select: 'circle'
    };
    var app = getApp();
