...
Page({
  data: {
    imgUrls: [
      'http://47.100.44.255/images/product/detail-mangguogan/01.JPG',
      'http://47.100.44.255/images/product/detail-mangguogan/02.JPG',
      'http://47.100.44.255/images/product/detail-mangguogan/03.JPG'
    ],
  ...
  toCar() {
    ...
    var cargo = {
      ...
      num: num,
      name: '芒果干120g*3袋',
      url: 'http://47.100.44.255/images/product/detail-mangguogan/01.JPG',
      price: '27.90',
      select: 'circle'
    };
    var app = getApp();
