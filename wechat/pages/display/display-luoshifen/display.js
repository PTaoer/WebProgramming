...
Page({
  data: {
    imgUrls: [
      'http://47.100.44.255/images/product/detail-luoshifen/01.JPG',
      'http://47.100.44.255/images/product/detail-luoshifen/02.JPG'
    ],
  ...
  toCar() {
    ...
    var cargo = {
      ...
      num: num,
      name: '广西螺狮粉300g*6包',
      url: 'http://47.100.44.255/images/product/detail-luoshifen/01.JPG',
      price: '34.90',
      select: 'circle'
    };
    var app = getApp();
