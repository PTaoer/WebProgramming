...
Page({
  data: {
    imgUrls: [
      'http://47.100.44.255/images/product/detail-yaoguo/01.jpg',
      'http://47.100.44.255/images/product/detail-yaoguo/02.jpg',
      'http://47.100.44.255/images/product/detail-yaoguo/03.jpg'
    ],
  ...
  toCar() {
    ...
    var cargo = {
      ...
      num: num,
      name: '炭烧腰果500g干果',
      url: 'http://47.100.44.255/images/product/detail-yaoguo/01.jpg',
      price: '32.00',
      select: 'circle'
    };
    var app = getApp();
