...
Page({
  data: {
    imgUrls: [
      'http://47.100.44.255/images/product/detail-bigenguo/01.jpg',
      'http://47.100.44.255/images/product/detail-bigenguo/02.jpg',
      'http://47.100.44.255/images/product/detail-bigenguo/03.jpg',
    ],
  ...
  toCar() {
    ...
    var cargo = {
      code: '0001',
      num: num,
      name: '碧根果240g 每日坚果奶香口味零食美味',
      url: 'http://47.100.44.255/images/product/detail-bigenguo/01.jpg',
      price: '38.80',
      select: 'circle'
    };
    var app = getApp();
